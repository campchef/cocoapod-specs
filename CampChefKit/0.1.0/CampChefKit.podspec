...
Pod::Spec.new do |s|
  s.name             = 'CampChefKit'
  s.version          = '0.1.0'
  s.summary          = 'v4 Communication Protocol for CampChefKit'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
Communication layer used to CampChefConnect to facilitate grill communication
                       DESC
  ...
  s.dependency 'KhrysalisRuntime', '1.0.0-rc1'
  s.dependency 'LightningServer', '0.1.0'
end
